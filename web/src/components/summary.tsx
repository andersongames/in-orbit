...
import { undoGoalCompletion } from '../http/undo-goal-completion.ts'
    ...
    <div className="py-10 max-w-[480px] px-5 mx-auto flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-6">
          <h2 className="text-xl font-medium">Sua semada</h2>
                  ...
                  {goals.map(goal => {
                    ...
                    return (
                      <li key={goal.id} className="flex items-center gap-2">
                        ...
                        <button
                          type="button"
                          className="text-zinc-500 text-xs text-decoration-line: underline"
